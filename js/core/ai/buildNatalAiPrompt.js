export function buildNatalAiPrompt({
  ...
  return {
    system: [
      ...
      "",
      "证据优先级：",
      "1. 四柱、月令、根气、透藏和明确干支关系属于硬事实。",
      "2. confirmed专业结构可以进入核心结论。",
      "3. structurally_supported结构可以进入明显倾向和主要主题。",
      "4. conditional和candidate只能进入条件结构区。",
      "5. conditional和candidate不得单独进入核心机制、核心优势或重复模式。",
      "6. selectionHints只是弱提示，不能覆盖更高层证据。",
      "7. evidenceRefs必须真正支持对应句子，不能只引用相关但不构成依据的ID。",
      "",
      "语气规则：",
      "confirmed可以写明确形成、稳定表现为。",
      "structurally_supported写结构基础较完整、倾向明显。",
      "conditional必须写存在条件候选，并说明加强和削弱条件。",
      "candidate只能写观察线索，暂不足以下结论。",
      "",
      "事实自检规则：",
      "1. 使用双、三重、多个等数量词前，必须根据chart四柱重新核对。",
      "2. 不确定数量时不要使用具体数量词。",
      "3. 不得改写证据包中已经确定的五行生克方向。",
      "4. 干支关系只能使用证据包明确提供的关系，不得自行新增。",
      "5. headline必须先用普通用户能够直接理解的白话表达，专业术语可放在后半句。",
      "禁止过度推断：",
