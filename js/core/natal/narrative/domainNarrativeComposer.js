...
const domainFallbacks = {
  self:
    "命主自身目前以日主、强弱和柱位等基础事实为主，高阶组合不算特别集中。",

  parents:
    "父母家庭目前以年柱、月柱和印星等基础事实为主，家庭支持与长辈影响需要结合具体柱位理解。",

  siblings:
    "兄弟同辈目前以比劫和六亲位置等基础事实为主，同辈关系的轻重仍需结合现实反馈。",

  spouse:
    "夫妻感情目前以日支、配偶星和关系结构等基础事实为主，尚未形成特别集中的高阶主象。",

  children:
    "子女结果目前以时柱、食伤和成果输出等基础事实为主，具体表现需要结合现实阶段复核。",

  wealth:
    "财帛财富目前以财星和资源落点等基础事实为主，财富方式尚未形成特别集中的高阶结构。",

  health:
    "疾厄健康目前以五行分布、调候和体质结构等基础事实为主，只作原局体质倾向观察。",

  movement:
    "迁移环境目前以地支关系和环境事实为主，居住、出行和异地变化需要结合时间层判断。",

  friends:
    "交友人脉目前以比劫、关系和合作事实为主，圈层与合作方式需要结合现实反馈。",

  career:
    "官禄事业目前以官杀、月令和做工结构等基础事实为主，职业方向需要结合整体承载判断。",

  property:
    "田宅资产目前以土、库、财星和居住承载等基础事实为主，固定资产情况不宜只凭原局单断。",

  fortune:
    "福德精神目前以印星、食伤、调候和内在消化方式等基础事实为主，精神状态需要结合现实环境理解。",
};
