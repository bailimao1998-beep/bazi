...
import { buildStageAdvice as buildStageAdviceResult } from "../../domain/transit/advice/stageAdviceEngine.js";
import {
  buildLuckEvidencePack,
  buildMonthEvidencePack,
  buildYearEvidencePack,
} from "../../domain/shared/evidence/evidencePackBuilder.js";
import { buildLocalNarrative } from "../../domain/shared/evidence/narrativeBuilder.js";
import { escapeHtml } from "../../shared/html.js";
import { buildStagePresentationModel } from "../../domain/transit/buildStagePresentationModel.js";
...
export function renderAiCollapse({
  title,
  button,
  helper,
  state = {},
...
function renderAiWarnings(values = []) {
  ...
  return `
    <details class="ai-validation-notice">
      <summary>本次结果有 ${warnings.length} 项校验提醒，报告已照常展示</summary>
      <ul>
