...
import { buildStageRulePack } from "../../../js/domain/transit/buildStageRulePack.js";
import {
...
test("固定报告模型接入v8.4规则并区分章节", () => {
  ...
  assert.equal(luck.schemaVersion, "stage-fixed-report-v8.5.2");
...
test("旧固定叙事服务不再为空响应生成本地报告", async () => {
