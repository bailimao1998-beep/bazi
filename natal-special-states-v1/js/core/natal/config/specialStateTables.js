import { branches, stems } from "../../bazi/tenGods.js";
...
export const STORAGE_BRANCH_CONFIG = {
  辰: {
    branch: "辰",
    storageElement: "water",
    storageElementLabel: "水",
    storageLabel: "水库",
    storedStem: "癸",
  },
  戌: {
    branch: "戌",
    storageElement: "fire",
    storageElementLabel: "火",
    storageLabel: "火库",
    storedStem: "丁",
  },
  丑: {
    branch: "丑",
    storageElement: "metal",
    storageElementLabel: "金",
    storageLabel: "金库",
    storedStem: "辛",
  },
  未: {
