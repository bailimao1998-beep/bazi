...
import {
  ...
  resolveGrowthStage,
  resolveVoidBranches,
} from "../../js/domain/bazi/specialStateTables.js";
...
} from "../../js/domain/natal/config/specialStateTables.js";
...
test("calculateBazi consumes the shared special-state source", () => {
  ...
  const source = readFileSync("js/domain/bazi/calculateBazi.js", "utf8");
