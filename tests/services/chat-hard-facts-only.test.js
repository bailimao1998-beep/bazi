...
test(
  ...
  () => {
    ...
    assert.ok(payload.natalAuxiliaryFacts);
  },
);
...
test(
  ...
  () => {
    ...
    assert.ok(payload.yearHardFacts);
    assert.doesNotMatch(raw, /不要发送的流年故事|不要发送的流年现实解释/);
