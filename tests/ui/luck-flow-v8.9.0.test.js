...
test("luck contract uses the eight-step flow instead of the old five-domain report", () => {
...
test("luck flow renderer contains the requested eight-step visual structure", () => {
