...
const luck = readFileSync(new URL("../../styles/transit/luck-flow.css", import.meta.url), "utf8");
const ym = readFileSync(new URL("../../styles/transit/year-month-flow.css", import.meta.url), "utf8");
const ai = readFileSync(new URL("../../styles/chat/ai.css", import.meta.url), "utf8");
