...
} from "../../js/ui/transit/yearMonthFlowRenderer.js";
import {
  getStageAiOutputContract,
  validateStageAiReport,
} from "../../js/services/ai/contracts/stageAiReportContract.js";
import { buildStageGuidedPrompt } from "../../js/services/ai/transit/buildStageGuidedPrompt.js";
...
test("stage panel selects dedicated year and month renderers", () => {
  const source = fs.readFileSync(path.join(root, "js/ui/transit/stageAnalysisPanel.js"), "utf8");
